      ...
      <Collapse in={open}>
        <div id="example-collapse-text">
          ...
          <p className="aboutPara">
            ...
            quickly, Xfox offers Ad Promotion features. </p> <p className="aboutPara"> Xfox.com has an
            ...
            products through filtering options. </p><p className="aboutPara"> Doorstep Delivery is the
            ...
            sellers in online shopping. </p><p className="aboutPara"> For businesses, Xfox.com has
            ...
            and authorized dealers. </p><p className="aboutPara"> With millions of unique monthly visitors,
          ...
          <p className="aboutPara">
          At Xfox, we make it so easy to connect people to buy, sell or rent goods and services as other classified sites. </p><p className="aboutPara"> - Fast & Easy Experience: Navigated buying and selling experience in Bangladesh which is simpler, faster, and easier. Shop and sell on the go and get your desired products in just a few clicks. </p><p className="aboutPara"> - Post Ads Free: As a free classified website, we offer free ad posting features in many categories for the convenience of the users based on their locations. </p><p className="aboutPara"> - Safe & Secure Shopping: We have listed our verified members and authorized dealers to create a safe shopping experience for our users.
          </p>
        </div>
      </Collapse>
      <button
